...
Here, we are going to use a large scale simulated data set to show the perforamnce of HGWR model.
As the true value of coefficients are already known (stored in variable `hgwr_beta`),
closeness between estimated and true values is an appliable perforamnce metric.
